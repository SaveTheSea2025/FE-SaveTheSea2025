...
const PersonalSignupPage: React.FC = () => {
    ...
    // 🟢 Blob URL 사용 및 메모리 정리 로직 (5MB 제한 추가됨)
    ...
    const handleSendCode = async () => {
        ...
        try {
            ...
            if (res.code === 0) {
                ...
                setTimer(600); // 3분 -> 10분으로 변경 요청 시 여기 수정 (현재 600초=10분 적용)
            } else {
                ...
                <div className="bg-white p-10 md:p-14 shadow-xl rounded-xl">
                    ...
                    <div className="flex justify-center mb-12">
                        ...
                        <button
                            ...
                            className={`w-28 h-28 rounded-full flex flex-col items-center justify-center text-gray-400 hover:border-[#0C4A6E] overflow-hidden ${profileImage ? "border-4 border-[#0C4A6E]" : "border-2 border-gray-300"
                                }`}
                        >
                            {profileImage ? (
